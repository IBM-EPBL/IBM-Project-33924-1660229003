...
import ibm_db
import ibm_db_dbi
#from send_email import sendgridmail,sendmail
...
app.config['hostname'] = '54a2f15b-5c0f-46df-8954-7e38e612c2bd.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud'
app.config['port'] = '32733'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'vzq93202'
app.config['pwd'] = 'OIRHO37DPLeUSbSh'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=54a2f15b-5c0f-46df-8954-7e38e612c2bd.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=32733;protocol=tcpip;\
            uid=vzq93202;pwd=OIRHO37DPLeUSbSh;security=SSL'
